   ...
   <div class="sidebar one_quarter first">
        ...
        <h6>Quick Links</h6>
         ...
         <li ><a href="../plan_price/plan.php">Plan & Pricing</a></li>  
          ...
          <li class="selected"><a href="../career/career.php">Career</a></li>
      ...
      <h6>Come Join With Us</h6>
      </div>
     <div class="two_third"  style="padding:20px; margin-top:-45px;">
     <p>
     <h4>We Are Looking for Business Development Executive </h4>
        <b>Job Description</b><p>
        <hr />
        
1. Setup portfolio on website and get portfolio on website and get Clients.<br />
2. Should be comfortable in client interaction.<br />
3. Should have knowledge of Types of certification procedure <br />
4. Excellent knowledge of MS office, making proposals in  doc and ppt. <br />
5. Follow up to potential leads. A go getter.<br /> 
6. Strong English speaking and writing skills. <br />      
      </div>
    <!-- ################################################################################################ -->
    <!-- / main body -->
    <div class="clear"></div>
